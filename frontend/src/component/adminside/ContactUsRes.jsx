...
const ContactUsRes = () => {
 ...
 /* const sendData = async (e) => {
    ...
    try {
      const postResponse = await axios.post("http://localhost:5000/contactus/addresponse", {
        id: contact._id,
...
const sendData = async (e) => {
  ...
  try {
    if (editMode) {
      ...
      await axios.put(`http://localhost:5000/contactus/${id}`, {
        response: responseText,
      });
      ...
      await axios.post("http://localhost:5000/contactus/addresponse", {
        id: contact._id,
        response: responseText,
      });
      toast.success("Response saved successfully", {
