...
const EditDes = () => {
  ...
  const handleDelete = () => {
    axios.delete('http://localhost:5000/dest/deletedest/' + id).then(() => {
        ...
        <table class="table w-[85%] h-[auto] bg-white rounded table-bordered table-striped table-hover" style={style}>
          ...
          <tbody class="table-group-divider rounded">
            <tr className='text-xl p-4 '>
              ...
              <td rowSpan={8} className=' flex justify-center items-center text-center p-3'><button className=' p-1 text-blue-50 bg-blue-600 rounded'><a className=' text-white' href={`http://localhost:5000/Upload/images/` + listPoints.pdf} download>Download</a></button></td>
            </tr>
