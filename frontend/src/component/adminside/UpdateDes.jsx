...
const UpdateDes = () => {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post('http://localhost:5000/dest/updatedest/' + id, {
            ...listPoints2,
    ...
    const upload = () => {
        ...
        axios.post("http://localhost:5000/dest/updatepdf/" + id, formdata)
            .then(res => {
                        ...
                        <div className="des-add-box ">
                            ...
                            <form onSubmit={handleSubmit}  >
                                ...
                                <div className="box-input-row  mb-4">
                                    ...
                                    {/* <button className='p-2 bg-blue-500'><a href={`http://localhost:5000/Upload/images/` + listPoints.pdf } download className=' text-white'>Download</a></button> */}
                                </div>
